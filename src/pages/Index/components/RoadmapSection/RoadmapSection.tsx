function RoadmapSection() {
  return (
    <div className="section-wrapper bg-gray-5 bg-[url('/roadmap-bg.png')] bg-contain bg-no-repeat px-10 pt-[21.375rem] items-center relative">
      <div className="bg-gray-2 text-gray-6 rounded-[20px] pt-[3.875rem] pb-[9.813rem] px-10 lg:px-24 w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,_1fr)_minmax(1rem,_14.5rem)_minmax(0,_1fr)] max-lg:gap-y-20">
          ...
          <div className="max-lg:hidden row-span-3 flex flex-col items-center mt-[22px] mb-[350px] relative">
      ...
      <div className="absolute bottom-0 inset-x-0 h-5 bg-gray-5/75 mix-blend-multiply z-10" />
    </div>
  );
}
