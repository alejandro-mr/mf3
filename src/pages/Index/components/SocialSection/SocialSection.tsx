...
function SocialSection() {
  return (
    <div className="section-wrapper bg-gray-6 relative z-0 after:-z-10 after:absolute after:inset-0 after:bg-gray-5/75 after:mix-blend-multiply items-center py-[8.25rem]">
      <GlassCard>
        ...
        <div className="max-w-[44.75rem] pt-[3.125rem] pb-16 px-[6.5rem] flex flex-col gap-9">
          ...
          <div className="grid grid-cols-3 gap-16 font-semibold text-lg">
            <FacebookLink />
            <InstagramLink />
            <TiktokLink />
          </div>
